...
- Om arbetet visar att en gammal TODO-punkt är inaktuell, verifiera det innan den ändras eller stängs.
- Om arbetet leder till en tydlig ny följduppgift som ska göras senare, lägg till den i `TODO.md` innan arbetet avslutas.
